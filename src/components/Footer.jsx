    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center mb-6">
              ...
              <div className="ml-2 text-xl font-playfair font-bold text-white">Skyra Events</div>
            </div>
            <p className="mb-4">
              A comprehensive event management platform that allows users to search, customize, and
              book event services and venues with real-time availability and secure payments.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>123 Event Street, City Name, Country</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="flex items-start">
                ...
                <span>info@skyraevents.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center">
          <p>&copy; {new Date().getFullYear()} Skyra Events. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
